        ...
        >
            ...
            >
                <div class="flex items-center space-x-4">
                    <Link
                        :href="
                            route('frontend.communities.posts.show', [community.slug, post.slug])
                        "
                        class="text-slate-800 dark:text-slate-400 font-semibold truncate text-sm hover:text-indigo-700"
                    >
                        {{ post.title }}
